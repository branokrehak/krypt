    ...
    <div className="flex w-full justify-center items-center">
      <div className="flex md:flex-row flex-col items-start justify-between md:p-10 py-12 px-4">
        <div className="flex flex-1 justify-start flex-col md:mr-10">
          ...
          <div className="grid lg:grid-cols-3 grid-cols-2 w-full mt-10">
            <div className={`rounded-tl-2xl ${commonStyles}`}>
              Reliability
            </div>
            <div className={`lg:rounded-tr-none rounded-tr-2xl ${commonStyles}`}>
              Security
            </div>
            <div className={`lg:rounded-tr-2xl ${commonStyles}`}>
              Ethereum
            </div>

            <div className={`lg:rounded-bl-2xl ${commonStyles}`}>
              Web 3.0
            </div>
            <div className={`lg:rounded-bl-none rounded-bl-2xl ${commonStyles}`}>
              Low fees
            </div>
